...
<template>
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col"><h3 class="m-0">Plakátek</h3></div>
      <div class="col align-content-center"><span class="text-truncate"><badge :type="currentEventLabel.who" /><b>{{ currentEventLabel.title }}</b></span></div>
    </div>
